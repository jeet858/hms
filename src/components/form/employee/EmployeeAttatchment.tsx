...
interface EmpDocumentUploadForm {
...
interface Iprops {
  data: EmpDocumentUploadForm;
  setData: Dispatch<SetStateAction<EmpDocumentUploadForm>>;
  saveAndNextClick: () => void;
}
const EmployeeAttatchment: React.FunctionComponent<Iprops> = ({
  data,
  saveAndNextClick,
  setData,
}) => {
...
export default EmployeeAttatchment;
